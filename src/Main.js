    ...
    <main className="lg:min-h-[calc(100vh-88px-72px)]">
      <div className="flex flex-col h-full lg:flex-row">
        ...
        <Product
          ...
          iconPath={<path d="M28 20L24 22M24 22L20 20M24 22V27M40 14L36 16M40 14L36 12M40 14V19M28 8L24 6L20 8M8 14L12 12M8 14L12 16M8 14V19M24 42L20 40M24 42L28 40M24 42V37M12 36L8 34V29M36 36L40 34V29" stroke="#344E4F" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>}
        ...
        <Product
          ...
          iconPath={<path stroke="#1A2C5C" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M24.5 42.5V26M32 42.5V26M17 42.5V26M6.5 18.5l18-12 18 12m-3 24V21.164A96.714 96.714 0 0 0 24.5 20c-5.102 0-10.112.4-15 1.164V42.5m-3 0h36M24.5 14h.016v.016H24.5V14Z"/>}
